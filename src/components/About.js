...
const About=()=>{
    return (
        <Card className="about">
            ...
            <Card.Body>
                <Card.Title style={{fontFamily: 'Caveat',fontSize:'30px'}}>I'm a Computer Science Student from Nepal currently studying in VIT, India.I'm in this field of work because I like exploring the tech world and I enjoy the tech world since I'm in this field.I'm highly interested in software development side of things and specifically my enthusiasm lies towards the fields of Web Development and Artificial Intelligence.  </Card.Title>
