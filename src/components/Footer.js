    ...
    return (
        <Card className="foot">
            ...
            <ListGroup horizontal>
                ...
                <ListGroup.Item ><a style={{color:'#bc2a8d'}} rel="noreferrer" target='_blank' href='https://www.instagram.com/sgm4u/'><i className="fab fa-instagram fa-2x"></i></a></ListGroup.Item>
                <ListGroup.Item ><a style={{color:'#00acee'}} rel="noreferrer" target='_blank' href='https://twitter.com/itsmesugam'><i className="fab fa-twitter-square fa-2x"></i></a></ListGroup.Item>
